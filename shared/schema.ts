...
export const boats = pgTable("boats", {
  ...
  trailerIncluded: boolean("trailer_included"),
  ...
  warnings: text("warnings").array().default(sql`ARRAY[]::text[]`),
...
export const insertBoatSchema = createInsertSchema(boats).omit({
  ...
  manufacturerCountry: z.string().optional().nullable(),
  category: z.string().optional().nullable(),
  length: z.number().positive().optional().nullable(),
  width: z.number().positive().optional().nullable(),
  draft: z.number().positive().optional().nullable(),
  maxPassengers: z.number().int().positive().optional().nullable(),
  hullMaterial: z.string().optional().nullable(),
  boatType: z.string().optional().nullable(),
  engineType: z.string().optional().nullable(),
  trailerIncluded: z.boolean().optional().nullable(),
